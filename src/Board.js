 ...
 */
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      var rows = this.rows();
      return rows.reduce(function(memo, row, rowIndex) {
        var ind = rowIndex + majorDiagonalColumnIndexAtFirstRow;
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      var rows = this.rows();
      return rows.reduce(function(memo, row, rowInd) {
        var ind = (-1 * rowInd) + minorDiagonalColumnIndexAtFirstRow;
        if (row[ind] === undefined) {
          return memo;
        } else {
          return memo + row[ind];
        }
